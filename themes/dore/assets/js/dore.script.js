...
$.shiftSelectable = function (element, config) {
  ...
  var $container = $(document).find(element);
  var $checkAll = null;
  var lastChecked;
  if ($container.data("checkAll")) {
    $checkAll = $("#" + $container.data("checkAll"));
    $checkAll.on("click", function () {
      $(document).find(element).find("input[type='checkbox']").prop("checked", $($checkAll).prop("checked")).trigger("change");
  ...
  function itemClick(checkbox, shiftKey) {
    ...
    if (lastChecked) {
      if (shiftKey) {
        var start = $(document).find(element).find("input[type='checkbox']").index(checkbox);
        var end = $(document).find(element).find("input[type='checkbox']").index(lastChecked);
        $(document).find(element).find("input[type='checkbox']")
    ...
    if ($checkAll) {
      ...
      var allChecked = true;
      $(document).find(element).find("input[type='checkbox']").each(function () {
...
$.dore = function (element, options) {
  ...
  function init() {
    ...
    /* 03.04. Shift Selectable Init */
    $shiftSelect = $(document).find(".list").shiftSelectable();
