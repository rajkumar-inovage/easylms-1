					...
					if (! empty($categories)) {
						foreach ($categories as $row) {
							...
							<tr>
								...
								<td>
								<?php 
									echo anchor ('coaching/virtual_class/index/'.$coaching_id.'/'.$row['id'], $row['title']);
								?>
								</td>
								<td>
									<!-- Rename -->
									...
									<div class="modal fade" id="rename<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="renameNode" aria-hidden="true">
									  <div class="modal-dialog" role="document">
										<div class="modal-content">
										   <?php echo form_open ('coaching/virtual_class_actions/add_category/'.$coaching_id.'/'.$row['id'], array ('class'=>'validate-form')); ?>
									...
									$url = site_url('coaching/virtual_class_actions/remove_category/'.$coaching_id.'/'.$row['id']);
									?>
...
<div class="modal fade" id="add_category" tabindex="-1" role="dialog" aria-labelledby="renameNode" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	   <?php echo form_open ('coaching/virtual_class_actions/add_category/'.$coaching_id, array ('class'=>'validate-form')); ?>
		  <div class="modal-header">
