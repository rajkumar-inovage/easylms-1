...
<body id="app-container" class="menu-sub-hidden show-spinner <?php if (isset ($right_sidebar) && $right_sidebar == true) { echo 'right-menu'; } ?>">
    ...
    <nav class="navbar fixed-top">
        <div class="d-flex align-items-center navbar-left">
            ...
            <a class="btn btn-sm btn-outline-primary ml-3 d-none d-md-inline-block" href="<?php echo site_url('student/courses/index/'.$coaching_id. '/'.$this->session->userdata ('member_id')); ?>" data-toggle="tooltip" data-placement="right" title="Buy Course"><i class="simple-icon-book-open"></i> Catalog </a>
        </div>

        <a class="navbar-logo" href="<?php echo $this->common_model->coaching_url ($coaching_id); ?>">
            <span class="logo d-block d-xs-none"<?php echo $this->common_model->coaching_logo ($coaching_id); ?>></span>
        ...
        <div class="navbar-right">
            ...
            <div class="user d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-right mt-3">
                    <a class="dropdown-item py-0" href="<?php echo site_url ('student/users/my_account/'.$coaching_id.'/'.$member_id); ?>">
                        <div class="d-flex">
                            <i class="flex-shrink-0 iconsminds-id-card fa-2x"></i>
                            <span class="flex-grow-1 my-auto ml-1">My Account</span>
                        </div>
                    </a>
                    <a class="dropdown-item py-0" href="<?php echo site_url ('student/users/my_password/'.$coaching_id.'/'.$member_id); ?>">
                        <div class="d-flex">
                ...
                <div class="col-12">
                    <?php 
                        if (isset ($bc)) {
                            $bc_link = current ($bc);
                            $bc_title  = key ($bc);
                            echo anchor ($bc_link, '<i class="fa fa-long-arrow-alt-left"></i> Back', array('class'=>'icon-button mr-2', 'title'=>'Back To '.$bc_title)); 
                        }
                    ?>
                    <?php /* if (isset($page_title)) {?>

                        <div class="mb-2">
                            <div class="position-relative float-none float-lg-left mb-3 mb-md-0">
                            </div>
                            <h1>
                            ...
                            <div class="position-relative float-right">
                                <button type="button" class="btn btn-outline-primary icon-button active" id="toolbar-button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
